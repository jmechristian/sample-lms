...
const LinksButton = () => {
  return (
    <Popover className='fixed bottom-0 right-8 drop-shadow-2xl z-[80]'>
      <Popover.Button className='w-16 md:w-80'>
        <div className='bg-zinc-700 text-white font-medium text-lg flex items-center py-3 px-6 gap-2 rounded-t-lg'>
          <div>
      ...
      <Popover.Panel className='bg-gray-500 w-80'>
